...
const store = new JsonStore({
  filePath: resolveDataFile('factions'),
  defaultValue: { requirements: [], assignments: [] },
  validate: value => value && Array.isArray(value.requirements) && Array.isArray(value.assignments),
})
