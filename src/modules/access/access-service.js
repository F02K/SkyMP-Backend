...
const accessStore = new JsonStore({
  filePath: resolveDataFile('accessPolicy'),
  defaultValue: {},
  validate: value => value && typeof value === 'object' && !Array.isArray(value),
})
const whitelistStore = new JsonStore({
  filePath: resolveDataFile('whitelist'),
  defaultValue: [],
...
function save(data) { accessStore.write(normalize(data)) }
...
function loadFileWhitelist() { return whitelistStore.read() }

function saveFileWhitelist(discordIds) { whitelistStore.write(uniq(discordIds)) }
